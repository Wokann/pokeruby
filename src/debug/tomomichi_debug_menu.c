...
static const u16 gUnknown_Debug_083C271A[][9] = {
    ...
    {FLAG_HIDE_WALLY_PETALBURG, FLAG_HIDE_WALLY_DEFEATED_VICTORY_ROAD, FLAG_HIDE_WALLY_MAUVILLE, FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WALLY, FLAG_HIDE_WALLY_BATTLE_VICTORY_ROAD, FLAG_HIDE_WALLY_PETALBURG_GYM, FLAG_UNKNOWN_363, FLAG_HIDE_WEATHER_INSTITUTE_WORKERS_1F, FLAG_HIDE_WEATHER_INSTITUTE_WORKERS_2F},
    ...
    {FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_RIVAL, FLAG_HIDE_RIVAL_CHAMPIONS_ROOM, FLAG_HIDE_RIVAL_RUSTBORO, FLAG_HIDE_RIVAL_LILYCOVE_MART, FLAG_HIDE_ROUTE_103_RIVAL, FLAG_HIDE_ROUTE_110_RIVAL, FLAG_HIDE_RIVAL_ROUTE119, FLAG_HIDE_LAVARIDGE_TOWN_RIVAL, FLAG_HIDE_OLDALE_TOWN_RIVAL}
};
