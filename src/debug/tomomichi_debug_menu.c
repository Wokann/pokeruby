...
static const u16 gUnknown_Debug_083C354A[][9] = {
    ...
    {VAR_RECYCLE_GOODS, VAR_STARTER_MON, VAR_MIRAGE_RND_H, VAR_MIRAGE_RND_L, VAR_DAYS, VAR_FANCLUB_FAN_COUNTER, VAR_FANCLUB_LOSE_FAN_TIMER, VAR_TRICK_HOUSE_LEVEL, VAR_LOTTERY_PRIZE},
