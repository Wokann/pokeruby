...
static const u16 gUnknown_Debug_083C19C6[][9] = {
    ...
    {FLAG_SYS_NATIONAL_DEX, FLAG_SYS_SHOAL_TIDE, FLAG_SYS_RIBBON_GET, FLAG_SYS_PC_LANETTE, FLAG_SYS_EXDATA_ENABLE, FLAG_SYS_BRAILLE_DIG, FLAG_SYS_REGIROCK_PUZZLE_COMPLETED, FLAG_SYS_BRAILLE_WAIT, FLAG_SYS_BRAILLE_FLY},
...
static const u16 gUnknown_Debug_083C271A[][9] = {
    ...
    {FLAG_HIDE_BELDUM_BALL_STEVENS_HOUSE, FLAG_HIDE_DEVON_RUSTBORO, FLAG_HIDE_UNDERWATER_SUBMARINE_INTERACTION, FLAG_HIDE_LILYCOVE_MOTEL_PEOPLE, FLAG_HIDE_ROOFTOP_LADY_LILYCOVE_MART, FLAG_HIDE_TRICK_HOUSE_ENTRANCE_MAN, 0x352, FLAG_HIDE_LITTLEROOT_TOWN_MAYS_HOUSE_RIVAL_BEDROOM, FLAG_HIDE_LITTLEROOT_TOWN_BRENDANS_HOUSE_RIVAL_BEDROOM},
    {FLAG_HIDE_ROUTE_101_BIRCH_POOCHYENA_BATTLE, FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_BIRCH, FLAG_UNKNOWN_BIRCH_380, FLAG_HIDE_ROUTE_101_BIRCH, FLAG_HIDE_ROUTE_103_BIRCH, FLAG_HIDE_BIRCH_CHAMPIONS_ROOM, FLAG_HIDE_BOYFRIEND_RUSTURF_TUNNEL, FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WANDAS_BOYFRIEND, FLAG_HIDE_ROUTE_116_WANDAS_BOYFRIEND},
    {FLAG_HIDE_PETALBURG_CITY_WALLY, FLAG_HIDE_WALLY_DEFEATED_VICTORY_ROAD, FLAG_HIDE_WALLY_MAUVILLE, FLAG_HIDE_VERDANTURF_TOWN_WANDAS_HOUSE_WALLY, FLAG_HIDE_WALLY_BATTLE_VICTORY_ROAD, FLAG_HIDE_PETALBURG_GYM_WALLY, FLAG_UNKNOWN_363, FLAG_HIDE_WEATHER_INSTITUTE_1F_WORKERS, FLAG_HIDE_WEATHER_INSTITUTE_2F_WORKERS},
    {FLAG_HIDE_STEVEN_GRANITE_CAVE, FLAG_HIDE_ROUTE_128_STEVEN, FLAG_HIDE_ROUTE_118_STEVEN, FLAG_HIDE_STEVEN_STEVENS_HOUSE, FLAG_HIDE_ROUTE_120_STEVEN, FLAG_HIDE_STEVEN_SOOTOPOLIS},
    {FLAG_HIDE_SLEEPING_MON_SEAFLOOR_CAVERN, FLAG_UNKNOWN_2E1, FLAG_UNKNOWN_2EC, FLAG_HIDE_ROUTE_101_POOCHYENA, FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_HOUSE_MACHOKE_1, FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_HOUSE_MACHOKE_2, 0x305, FLAG_HIDE_PEEKO_RUSTURF_TUNNEL, FLAG_HIDE_BRINEYS_HOUSE_PEEKO},
    {FLAG_HIDE_LITTLEROOT_TOWN_MOM_OUTSIDE, FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_BEDROOM_MOM, FLAG_HIDE_LITTLEROOT_TOWN_BRENDANS_HOUSE_MOM, FLAG_HIDE_LITTLEROOT_TOWN_MAYS_HOUSE_MOM, FLAG_UNKNOWN_30E, FLAG_UNKNOWN_30F, FLAG_HIDE_ROUTE_110_RIVAL_ON_BIKE, FLAG_HIDE_ROUTE_119_RIVAL_ON_BIKE, FLAG_HIDE_LAVARIDGE_TOWN_RIVAL_ON_BIKE},
    {FLAG_HIDE_ROUTE_104_MR_BRINEY, FLAG_HIDE_BRINEYS_HOUSE_MR_BRINEY, FLAG_HIDE_MR_BRINEY_DEWFORD_TOWN, FLAG_HIDE_ROUTE_109_MR_BRINEY, FLAG_UNKNOWN_34F, FLAG_HIDE_BRINEY_SLATEPORT_SHIPYARD, FLAG_HIDE_BRINEY_RUSTURF_TUNNEL, FLAG_HIDE_ROUTE_116_MR_BRINEY, FLAG_HIDE_BRINEY_AND_PEEKO_SS_TIDAL},
    {FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_RIVAL, FLAG_HIDE_RIVAL_CHAMPIONS_ROOM, FLAG_HIDE_RIVAL_RUSTBORO, FLAG_HIDE_LILYCOVE_CITY_RIVAL, FLAG_HIDE_ROUTE_103_RIVAL, FLAG_HIDE_ROUTE_110_RIVAL, FLAG_HIDE_ROUTE_119_RIVAL, FLAG_HIDE_LAVARIDGE_TOWN_RIVAL, FLAG_HIDE_OLDALE_TOWN_RIVAL}
};
...
static const u16 gUnknown_Debug_83C31E6[][9] = {
    {FLAG_RECEIVED_HM01, FLAG_RECEIVED_HM02, FLAG_RECEIVED_HM_SURF, FLAG_RECEIVED_HM04, FLAG_RECEIVED_HM05, FLAG_RECEIVED_HM06, FLAG_RETURNED_DEVON_GOODS, FLAG_DEVON_GOODS_STOLEN, FLAG_RECOVERED_DEVON_GOODS},
...
static const u16 gUnknown_Debug_083C354A[][9] = {
    ...
    {VAR_REPEL_STEP_COUNT, VAR_ICE_STEP_COUNT, VAR_ASH_GATHER_COUNT, VAR_CRUISE_STEP_COUNT, VAR_FRIENDSHIP_STEP_COUNTER, VAR_POISON_STEP_COUNTER},
    {VAR_RECYCLE_GOODS, VAR_STARTER_MON, VAR_MIRAGE_RND_H, VAR_MIRAGE_RND_L, VAR_DAYS, VAR_FANCLUB_FAN_COUNTER, VAR_FANCLUB_LOSE_FAN_TIMER, VAR_TRICK_HOUSE_LEVEL, VAR_POKELOT_PRIZE_ITEM},
    {VAR_NATIONAL_DEX, VAR_BIRCH_STATE, VAR_POKELOT_RND1, VAR_POKELOT_RND2, VAR_SECRET_BASE_MAP}
};
...
static const u16 sControlWorks_SaveWork_ItemArrays[][9] = {
    {VAR_CONTEST_HALL_STATE, VAR_CABLE_CLUB_STATE, VAR_CONTEST_LOCATION, VAR_CONTEST_PRIZE_PICKUP, VAR_LITTLEROOT_INTRO_STATE, VAR_SS_TIDAL_STATE},
    {VAR_TRICK_HOUSE_FOUND_TRICK_MASTER, VAR_TRICK_HOUSE_PRIZE_PICKUP, VAR_TRICK_HOUSE_ENTER_FROM_CORRIDOR, VAR_TRICK_HOUSE_ENTRANCE_STATE, VAR_TRICK_HOUSE_BEING_WATCHED_STATE},
    ...
    {VAR_SECRET_BASE_INITIALIZED, VAR_BOARD_BRINEY_BOAT_STATE, VAR_BRINEY_LOCATION, VAR_INIT_SECRET_BASE, VAR_LILYCOVE_CONTEST_LOBBY_STATE, VAR_ELITE_4_STATE, VAR_CABLE_CAR_STATION_STATE, VAR_SAFARI_ZONE_STATE, VAR_CYCLING_CHALLENGE_STATE},
    {VAR_WEATHER_INSTITUTE_STATE, VAR_SLATEPORT_FAN_CLUB_STATE, 0x40BB, VAR_BRAVO_TRAINER_BATTLE_TOWER_ON, VAR_E_READER_TRAINER_BATTLE_RESULT, VAR_WHICH_FOSSIL_REVIVED}
};
...
static const u16 gUnknown_Debug_083C4586[][9] = {
    {VAR_LITTLEROOT_TOWN_STATE, VAR_OLDALE_TOWN_STATE, VAR_DEWFORD_TOWN_STATE, VAR_LAVARIDGE_TOWN_STATE, VAR_CURRENT_SECRET_BASE, VAR_VERDANTURF_TOWN_STATE, VAR_PACIFIDLOG_TOWN_STATE, VAR_OLDALE_RIVAL_STATE},
    {VAR_PETALBURG_CITY_STATE, VAR_SLATEPORT_CITY_STATE, 0x4059, VAR_RUSTBORO_CITY_STATE, 0x405B, 0x405C, 0x405D, VAR_SOOTOPOLIS_CITY_STATE, 0x405F},
    {VAR_ROUTE101_STATE, VAR_ROUTE102_STATE, VAR_ROUTE103_STATE, VAR_ROUTE104_STATE, 0x4064, 0x4065, 0x4066, 0x4067, 0x4068},
    ...
    {VAR_LITTLEROOT_HOUSES_STATE_MAY, 0x4083, VAR_BIRCH_LAB_STATE, VAR_LITTLEROOT_HOUSES_STATE_BRENDAN, VAR_LITTLEROOT_RIVAL_STATE, VAR_PACIFIDLOG_TM_RECEIVED_DAY},
...
static bool8 debug_sub_808EC10(void)
{
    ...
    gSaveBlock1.vars[VAR_TRICK_HOUSE_LEVEL - VARS_START] = cursorPos;
    CloseMenu();
    return TRUE;
}
...
static bool8 debug_sub_808EC5C(void)
{
    ...
    VarSet(VAR_TRICK_HOUSE_ENTRANCE_STATE, cursorPos);
    CloseMenu();
    return TRUE;
}
