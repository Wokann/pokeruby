...
static const u16 gUnknown_Debug_083C271A[][9] = {
    ...
    {FLAG_HIDE_LITTLEROOT_TOWN_MOM_OUTSIDE, FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_BEDROOM_MOM, FLAG_HIDE_LITTLEROOT_TOWN_BRENDANS_HOUSE_MOM, FLAG_HIDE_LITTLEROOT_TOWN_MAYS_HOUSE_MOM, FLAG_UNKNOWN_30E, FLAG_UNKNOWN_30F, FLAG_HIDE_RIVAL_ON_BIKE_ROUTE110, FLAG_HIDE_RIVAL_ROUTE119_ON_BIKE, FLAG_HIDE_LAVARIDGE_TOWN_RIVAL_ON_BIKE},
    ...
    {FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_RIVAL, FLAG_HIDE_RIVAL_CHAMPIONS_ROOM, FLAG_HIDE_RIVAL_RUSTBORO, FLAG_HIDE_RIVAL_LILYCOVE_MART, FLAG_HIDE_ROUTE_103_RIVAL, FLAG_HIDE_RIVAL_ROUTE110, FLAG_HIDE_RIVAL_ROUTE119, FLAG_HIDE_LAVARIDGE_TOWN_RIVAL, FLAG_HIDE_OLDALE_TOWN_RIVAL}
};
